...
var editWorkout = function editWorkout(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  // console.log('Edit workout form data is ', data)
  api.editWorkout(data).then(ui.editWorkoutSuccess).catch(ui.editWorkoutFailure);
};

var addWorkout = function addWorkout(event) {
  // console.log('Add workout invoked')
  event.preventDefault();
  // console.log('Target is', event.target)
  var data = getFormFields(event.target);
  // console.log('Target data is ', data)
  api.addWorkout(data).then(ui.addWorkoutSuccess).catch(ui.addWorkoutFailure);
};

var getWorkouts = function getWorkouts(event) {
...
var deleteWorkout = function deleteWorkout(event) {
  // console.log('Delete workout event invoked')
  event.preventDefault();
  // console.log('Target is', event.target)
  var data = getFormFields(event.target);
  var modalName = '#deleteWorkoutModal' + data.workout.id;
  api.deleteWorkout(data).then($(modalName).modal('hide').on('hidden.bs.modal', ui.clearWorkouts)).then(ui.deleteWorkoutSuccess).catch(ui.deleteWorkoutFailure);
};

var analyzeWorkouts = function analyzeWorkouts(event) {
  // console.log('Analyze workout event invoked')
  event.preventDefault();
  // console.log('Target is', event.target)
  api.getWorkouts().then(ui.analyzeWorkoutSuccess).catch(ui.getWorkoutsFailure);
};

var generateWorkout = function generateWorkout(event) {
  var exerciseOne = exercisesOne[Math.floor(Math.random() * exercisesOne.length)];
  var exerciseTwo = exercisesTwo[Math.floor(Math.random() * exercisesTwo.length)];
  var exerciseThree = exercisesThree[Math.floor(Math.random() * exercisesThree.length)];
  var exerciseFour = exercisesFour[Math.floor(Math.random() * exercisesFour.length)];
  var exerciseFive = exercisesFive[Math.floor(Math.random() * exercisesFive.length)];
  var newWorkout = '4 rounds of: ' + exerciseOne + ', ' + exerciseTwo + ', ' + exerciseThree + ', ' + exerciseFour + ', ' + exerciseFive;

  var warmupOne = warmupOneList[Math.floor(Math.random() * warmupOneList.length)];
  var warmupTwo = rollerList[Math.floor(Math.random() * rollerList.length)];
  var newWarmup = warmupOne + ' then foam roller work of ' + warmupTwo + '. Stretch any other tight areas as necessary.';

  var mobilityOne = mobilityOneList[Math.floor(Math.random() * mobilityOneList.length)];
  var mobilityTwo = mobilityTwoList[Math.floor(Math.random() * mobilityTwoList.length)];
  var mobilityThree = mobilityThreeList[Math.floor(Math.random() * mobilityThreeList.length)];
  var newMobility = mobilityOne + ' followed by ' + mobilityTwo + ' and finish with ' + mobilityThree + '.';

  var strengthOne = strengthWork[Math.floor(Math.random() * strengthWork.length)];
...
var warmupOneList = ['5-7 minute run at 7 MPH', '5-7 minute row, low resistance', '5-7 minute jump rope'];
var rollerList = ['2 mins each side IT band mobility', '2 mins each side lat mobility', '3 min thoracic spine mobility'];
var mobilityOneList = ['2 mins each leg couch stretch', '2 mins each leg external rotation hip socket work', '2 mins each side hip opener'];
var mobilityTwoList = ['2 mins each side trap scrub', '2 mins each arm OH shoulder banded stretch', '2 mins each side back upper rib mobility', '2 mins each arm pec scrub against rack'];
var mobilityThreeList = ['15 reps slow OH squat with broomstick', '15 reps perfect bent row with barbell', '25 perfect air squats', '15 perfect deadlifts with empty barbell'];
var strengthWork = ['5 sets of 5-7 reps bench press @ 80% max followed by 2 sets of 12 reps @ 50% max', '5 sets of 5-7 OH press @ 80% max followed by 2 sets of 12 reps @ 50% max', '5 sets of 5-7 squats @ 80% max followed by 2 sets of 12 reps @ 50% max', '3 sets of 5-7 reps heavy deadlift. 2 sets of 12 reps @ 50% max'];

var exercisesOne = ['10 deadlift @ 115 lb', '15 thrusters @ 45lb', '10 back squats @ 110 lb', '15 back squats @ 95 lb', '12 OH lunges @ 45 lb', '10 front squats @ 95lb'];
var exercisesTwo = ['100 single unders', '15 burpees', '25 pushups', '7 burpees w/ 45 lb plate to OH'];
var exercisesThree = ['7 pullups', '15 KB swings', '15 box jumps', '25 body weight squats', '24 bodyweight lunges'];
var exercisesFour = ['5 toes to bar', '15 situps', '10 hanging knee raises'];
var exercisesFive = ['Run 400 M', 'Row 300 M'];
...
var store = __webpack_require__(2);
var showWorkoutsTemplate = __webpack_require__(17);
var events = __webpack_require__(6);

var addWorkoutSuccess = function addWorkoutSuccess(data) {
...
var addWorkoutFailure = function addWorkoutFailure(error) {
...
var getWorkoutsFailure = function getWorkoutsFailure(error) {
  // console.log('Get workout failure. Error is', error)
  $('#getWorkoutsModal').modal('hide');
  $('#getWorkoutsMessageModal').modal('show');
};

var editWorkoutSuccess = function editWorkoutSuccess(data) {
  // console.log('editWorkoutSuccess invoked. Data is', data)
  var modalName = '#editWorkoutModal' + data.workout.id;
...
var clearAnalysisData = function clearAnalysisData() {
  // console.log('Clear analysis data invoked')
  $('#analysistable').empty();
};

var analyzeWorkoutSuccess = function analyzeWorkoutSuccess(data) {
  ...
  var uniqueWorkoutTypes = Array.from(new Set(workoutTypes));
  ...
  uniqueWorkoutTypes.forEach(function (workoutTime) {
    var workoutNum = 0;
    var avgDuration = 0;
    var avgDifficulty = 0;
    for (var _i = 0; _i < data.workouts.length; _i++) {
      if (data.workouts[_i].workout_time === workoutTime) {
        workoutNum += 1;
        avgDuration += data.workouts[_i].duration;
        avgDifficulty += data.workouts[_i].difficulty;
      }
    }
...
module.exports = {
  ...
  analyzeWorkoutSuccess: analyzeWorkoutSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var workoutEvents = __webpack_require__(6);
var apiEvents = __webpack_require__(35);
...
var addWorkout = function addWorkout(data) {
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"row\">\n  <div class=\"col-sm-5\">\n    Workout ID "
    ...
    + "\n    <ul>\n      <li>Date: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.workout_date : stack1), depth0))
    + "</li>\n      <li>Time of Day: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.workout_time : stack1), depth0))
    + "</li>\n      <li>Duration: "
    ...
    + "</li>\n      <li>Type: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.exercise_type : stack1), depth0))
    + "</li>\n      <li>Description: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
    + "</li>\n    </ul>\n  </div>\n  <!-- Button for edit modal start -->\n  <div class=\"col-sm-4 workoutinfobutton\">\n    <button type=\"button\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#editWorkoutModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-resourceid=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Edit Workout</button>\n  </div>\n  <!-- Button for edit modal end -->\n  <!-- Edit modal start -->\n  <div class=\"modal fade\" id=\"editWorkoutModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\n    <div class=\"modal-dialog\" role=\"document\">\n      <div class=\"modal-content\">\n        <div class=\"modal-header\">\n          <h3 class=\"modal-title\" id=\"exampleModalLabel\">Edit My Workout</h3>\n          <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n            <span aria-hidden=\"true\">&times;</span>\n          </button>\n        </div>\n        <div class=\"modal-body\">\n          <form class=\"editWorkoutForm\">\n            <input type=\"hidden\" name=workout[id] value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n            <div class=\"form-group\">\n              <label for=\"workout-date-input\">Date</label>\n              <input class=\"form-control\" type=\"date\" name=\"workout[workout_date]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.workout_date : stack1), depth0))
    + "\" id=\"workout-date-input\" required>\n            </div>\n            <div class=\"form-group\">\n              <label for=\"workout-time-input\">Time of Day</label>\n              <input class=\"form-control\" type=\"text\" name=\"workout[workout_time]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.workout_time : stack1), depth0))
    + "\" id=\"workout-time-input\" required>\n            </div>\n            <div class=\"form-group\">\n              <label for=\"duration-input\">Duration (in minutes)</label>\n              <input class=\"form-control\" type=\"number\" min=\"1\" max=\"999\" name=\"workout[duration]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.duration : stack1), depth0))
    + "\" id=\"duration-input\" required>\n            </div>\n            <div class=\"form-group\">\n              <label for=\"difficulty-input\">Difficulty (1-10)</label>\n              <input class=\"form-control\" type=\"number\" min=\"1\" max=\"10\" name=\"workout[difficulty]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.difficulty : stack1), depth0))
    + "\" id=\"difficulty-input\" required>\n            </div>\n            <div class=\"form-group\">\n              <label for=\"exercise-type-input\">Exercise Type</label>\n              <input class=\"form-control\" type=\"text\" name=\"workout[exercise_type]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.exercise_type : stack1), depth0))
    + "\" id=\"exercise-type-input\" required>\n            </div>\n            <div class=\"form-group\">\n              <label for=\"description-input\">Description</label>\n              <textarea class=\"form-control\" rows=\"4\" name=\"workout[description]\" id=\"description-input\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
    + "</textarea>\n            </div>\n            <button type=\"submit\" class=\"btn btn-primary\">Confirm Changes</button>\n          </form>\n        </div>\n        <div class=\"modal-footer\">\n          <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Cancel</button>\n        </div>\n      </div>\n    </div>\n  </div>\n  <!-- Edit modal end -->\n  <!-- Modal for delete workout start -->\n  <!-- Button start -->\n  <div class=\"col-sm-4 workoutinfobutton\">\n    <button type=\"button\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#deleteWorkoutModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-resourceid=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete Workout</button>\n  </div>\n  <!-- Button end -->\n  <!-- Delete confirmation modal start -->\n  <div class=\"modal fade\" id=\"deleteWorkoutModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\n    <div class=\"modal-dialog\" role=\"document\">\n      <div class=\"modal-content\">\n        <div class=\"modal-header\">\n          <h3 class=\"modal-title\" id=\"exampleModalLabel\">Are you sure you want to delete workout "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "?</h3>\n          <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n            <span aria-hidden=\"true\">&times;</span>\n          </button>\n        </div>\n        <div class=\"modal-body\">\n          <form class=\"deleteWorkoutForm\">\n            <input type=\"hidden\" name=workout[id] value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n            <button type=\"submit\" class=\"btn btn-primary\">Yes</button>\n          </form>\n        </div>\n        <div class=\"modal-footer\">\n          <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Cancel</button>\n        </div>\n      </div>\n    </div>\n  </div>\n  <!-- Delete confirmation modal end -->\n  <!-- Modal for delete workout end -->\n</div>\n";
